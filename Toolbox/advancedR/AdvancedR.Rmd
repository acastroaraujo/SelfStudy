...
- In `R`, _almost_ everything is a vector. 
...
The `missing()` will help you determine if an argument's value comes from the user or from the default.
...
Functions with the `...` argument can take any number of additional arguments. You can also use `...` to pass those additional arguments to another function.
