...
```{r}
h01 <- function(x) 10
h01(asdASDFASDFdfasdfasdfasdfASADFEawef)
```

Lazy evaluation is powered by a data structure called a __promise__, or (less commonly) a [_thunk_](https://en.wikipedia.org/wiki/Thunk). 
