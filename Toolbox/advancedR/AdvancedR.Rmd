...
___Lookup tables (character subsetting)___
...
___Matching and merging by hand (integer subsetting)___
...
___Random samples and bootstraps (integer subsetting)___
...
___Ordering (integer subsetting)___
...
___Expanding aggregated counts (integer subsetting)___
...
___Removing columns from data frames (character)___

___Selecting rows based on a condition (logical subsetting)___
